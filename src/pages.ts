...
<main>
  <div class="hero">
    ...
    <h1>Koleksi endpoint siap pakai untuk <span class="accent">Project</span> kamu.</h1>
    <p class="sub">Api yang dipakai oleh seluruh sistem Dhaniels Store, sekarang bisa kamu pake juga.</p>
